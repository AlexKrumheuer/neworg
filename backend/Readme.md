...
* **Main Rows:**
    ...
    * `email`: `String` 
    * `passwordd`: `password`
    * `createdAt`: `LocalDateTime` (User creation date
...
| Method | Route | Description |
| :--- | :--- | :--- |
| `POST` | `/register` | It creates a user. |
| `POST` | `/login` | It signs in a user 
...
├── transaction/     # Transaction's Entity, Repository, Service and Controller of portfolio
